...
/**
 * Mostly a copy of T042_SeriesValuesTest. Except for sparsity.
 * 
 * @author Jean-Paul Vetterli
 * @version 1.0.0
 */
public class T043_SparseSeriesTest extends TestCase {

	private Database db;
	private static boolean clean;
	private static final String SERIES = "bt.test043.test";
